export function Contact() {
  return (
    <div className="grid gap-10 lg:grid-cols-[1fr_1.2fr]">
      <div>
        <h3 className="text-2xl font-semibold text-ink">Let’s talk about your technology needs</h3>
        <p className="mt-4 text-base leading-7 text-slate-600">
          Whether you need consulting support, project delivery help, or engineering capacity, Infotronic can help you engage quickly and professionally.
        </p>
